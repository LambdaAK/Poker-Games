"""Train a tabular REINFORCE policy for heads-up limit Hold'em."""

from __future__ import annotations

import argparse

from holdem_limit.rl import evaluate_vs_random, policy_table, train_self_play


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description=__doc__)
    parser.add_argument("--episodes", type=int, default=250_000, help="Self-play episodes")
    parser.add_argument("--lr", type=float, default=0.02, help="Policy learning rate")
    parser.add_argument("--baseline-lr", type=float, default=0.01, help="Baseline learning rate")
